...
Check degeneracy with another sample of random networks based on model parameters (instead of the diagnostic statistics used in the GOF above).


### Compare Estimation Algorithms: PMLE vs MCMCMLE

Compute the first model `m0` again but this time using MCMCMLE (instead of bootstrapped PMLE) and save to disk as an RDS (serialized) file:
```{r model02}
## set pseudorandom number generator seed for reproducibility
set.seed(1111)
## estimate the TERGM with bootstrapped PMLE
